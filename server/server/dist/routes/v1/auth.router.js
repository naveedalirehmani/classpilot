...
const authController = __importStar(require("../../controllers/v1/auth.controller"));
const oauth_router_1 = __importDefault(require("./oauth/oauth.router"));
...
authRouter.use("/oauth", oauth_router_1.default);
