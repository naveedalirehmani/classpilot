    ...
    <section className="container mx-auto px-4 mt-40 text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-24 max-w-5xl mx-auto my-20">
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-600 text-center">Generate lesson plans, worksheets, and unit plans in seconds.</p>
        </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-600 text-center">Track lessons from planning to completion with visual boards.</p>
        </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-600 text-center">Align with standards and build coherent teaching sequences.</p>
        </div>
      </div>
          ...
          <div className="relative flex -ml-10">
            ...
            <Card className="p-4 w-64 z-10 -mr-6 transform -rotate-3">
              ...
              <CardHeader className="p-0">
                <h4 className="text-xl font-bold text-center mb-2">Lesson Plan</h4>
              </CardHeader>
              <CardContent className="p-0">
                <p className="text-sm text-gray-600">
                  In today&apos;s math lesson, students will learn about fractions through interactive activities and visual
                  aids...
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="p-4 w-72 z-20">
              ...
              <CardHeader className="p-0">
                <h4 className="text-xl font-bold text-center mb-2">Kanban Board</h4>
              </CardHeader>
            ...
            <Card className="p-4 w-64 z-10 -ml-6 transform rotate-3">
              ...
              <CardHeader className="p-0">
                <h4 className="text-xl font-bold text-center mb-2">Unit Plan</h4>
              </CardHeader>
              <CardContent className="p-0 space-y-2 text-sm">
                <div className="font-medium">Objective</div>
                <p className="text-xs text-gray-600">
                  Students will understand the concept of fractions and their applications.
                </p>
