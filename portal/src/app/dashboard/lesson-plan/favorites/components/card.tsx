...
export function FavoritePlanCardSkeleton({ viewMode }: { viewMode: "grid" | "list" }) {
  if (viewMode === "list") {
    return (
...
export function EmptyFavorites() {
  return (
    <div className="w-full flex flex-col items-center justify-center py-12 text-center">
      ...
      <h3 className="text-xl font-medium text-gray-900 mb-1">No favorite lesson plans</h3>
      <p className="text-gray-500 max-w-md">
        You haven&apos;t added any lesson plans to your favorites yet. Browse your lesson plans and click the heart icon to add them to favorites.
      </p>
    </div>
  );
}
...
export function FavoritePlanCard({
  ...
  if (isLoading) {
    return <FavoritePlanCardSkeleton viewMode={viewMode} />;
  }
